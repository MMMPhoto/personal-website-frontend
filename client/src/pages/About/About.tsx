...
import { PageContainer, AboutCard, AboutContent, TwoColumnResponsive, TextParagraph } from "./styles";
      ...
      <AboutCard>
        ...
        <AboutContent>
          <TwoColumnResponsive>
            ...
            <img style={{width: "50%"}} src={maxAtTybee} alt="Max at the Beach" />
          ...
          <img style={{width: "50%"}} src={cameraDollyRocksHawaii} alt="Professional video camera on a dolly on a Hawaiian beach" />
          ...
          {/* PHOTO - FAMILY */}
          <img style={{width: "50%"}} src={familyPhotoAquarium} alt="Max and his family" />
